...
#define brewpanel_timer_control_create_boil_stop_button(buttons, images,timer) brewpanel_buttons_create_button(buttons,images,brewpanel_timer_control_boil_on_start_button_click,(mem_data)(&timer),BREWPANEL_IMAGES_ID_TIMER_STOP_IDLE, BREWPANEL_IMAGES_ID_TIMER_STOP_HOVER, BREWPANEL_IMAGES_ID_TIMER_STOP_CLICKED, BREWPANEL_IMAGES_ID_TIMER_STOP_DISABLED, BREWPANEL_TIMER_CONTROL_BOIL_STOP_X, BREWPANEL_TIMER_CONTROL_BOIL_STOP_Y)
#define brewpanel_timer_control_create_boil_pause_button(buttons,images,timer) brewpanel_buttons_create_button(buttons,images,brewpanel_timer_control_boil_on_start_button_click,(mem_data)(&timer),BREWPANEL_IMAGES_ID_TIMER_PAUSE_IDLE,BREWPANEL_IMAGES_ID_TIMER_PAUSE_HOVER,BREWPANEL_IMAGES_ID_TIMER_PAUSE_CLICKED,BREWPANEL_IMAGES_ID_TIMER_PAUSE_DISABLED,BREWPANEL_TIMER_CONTROL_BOIL_PAUSE_X,BREWPANEL_TIMER_CONTROL_BOIL_PAUSE_Y)
#define brewpanel_timer_control_create_boil_reset_button(buttons,images,timer) brewpanel_buttons_create_button(buttons,images,brewpanel_timer_control_boil_on_start_button_click,(mem_data)(&timer),BREWPANEL_IMAGES_ID_TIMER_RESET_IDLE,BREWPANEL_IMAGES_ID_TIMER_RESET_HOVER,BREWPANEL_IMAGES_ID_TIMER_RESET_CLICKED,BREWPANEL_IMAGES_ID_TIMER_RESET_DISABLED,BREWPANEL_TIMER_CONTROL_BOIL_RESET_X,BREWPANEL_TIMER_CONTROL_BOIL_RESET_Y)
