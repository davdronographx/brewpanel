...
enum BrewPanelImagesId : s16 {
    ...
    BREWPANEL_IMAGES_ID_KEYPAD_0                  = 48,
    BREWPANEL_IMAGES_ID_KEYPAD_1                  = 49,
    BREWPANEL_IMAGES_ID_KEYPAD_2                  = 50,
    BREWPANEL_IMAGES_ID_KEYPAD_3                  = 51,
    BREWPANEL_IMAGES_ID_KEYPAD_4                  = 52,
    BREWPANEL_IMAGES_ID_KEYPAD_5                  = 53,
    BREWPANEL_IMAGES_ID_KEYPAD_6                  = 54,
    BREWPANEL_IMAGES_ID_KEYPAD_7                  = 55,
    BREWPANEL_IMAGES_ID_KEYPAD_8                  = 56,
    BREWPANEL_IMAGES_ID_KEYPAD_9                  = 57,
    BREWPANEL_IMAGES_ID_HLT_TEMP_PANEL            = 58, 
    BREWPANEL_IMAGES_ID_MLT_TEMP_PANEL            = 59, 
    BREWPANEL_IMAGES_ID_BOIL_TEMP_PANEL           = 60,
    BREWPANEL_IMAGES_ID_MLT_ELEMENT_PANEL         = 61,
    BREWPANEL_IMAGES_ID_BOIL_ELEMENT_PANEL        = 62,
    BREWPANEL_IMAGES_ID_MODE_PANEL                = 63,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_IDLE     = 64,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_HOVER    = 65,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_CLICKED  = 66,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_DISABLED = 67,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_BOIL_IDLE     = 68,
