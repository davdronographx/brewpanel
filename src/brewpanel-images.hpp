...
enum BrewPanelImagesId : s16 {
    ...
    BREWPANEL_IMAGES_ID_MLT_ELEMENT_PANEL         = 60,
    BREWPANEL_IMAGES_ID_BOIL_ELEMENT_PANEL        = 61,
    BREWPANEL_IMAGES_ID_MODE_PANEL                = 62,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_IDLE     = 63,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_HOVER    = 64,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_CLICKED  = 65,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_MASH_DISABLED = 66,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_BOIL_IDLE     = 67,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_BOIL_HOVER    = 68,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_BOIL_CLICKED  = 69,
    BREWPANEL_IMAGES_ID_MODE_BUTTON_BOIL_DISABLED = 70,
    BREWPANEL_IMAGES_ID_COUNT                     = 71
};
