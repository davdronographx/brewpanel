...
enum BrewPanelImagesId : s16 {
    ...
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_SET_IDLE     = 115,
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_OFF_IDLE     = 116,
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_SET_HOVER    = 117,
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_OFF_HOVER    = 118,
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_SET_CLICKED  = 119,
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_OFF_CLICKED  = 120,
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_SET_DISABLED = 121,
    BREWPANEL_IMAGES_ID_KEYPAD_BUTTON_ELEMENT_OFF_DISABLED = 122,
    BREWPANEL_IMAGES_ID_MLT_ELEMENT_PANEL_INPUT            = 123,
    BREWPANEL_IMAGES_ID_BOIL_ELEMENT_PANEL_INPUT           = 124,
    BREWPANEL_IMAGES_ID_KEYPAD_PANEL_ACTIVE                = 125,
    BREWPANEL_IMAGES_ID_MLT_ELEMENT_PANEL_ON               = 126,
    BREWPANEL_IMAGES_ID_BOIL_ELEMENT_PANEL_ON              = 127,
    BREWPANEL_IMAGES_ID_TIMER_PANEL_MASH_INPUT              = 128,
    BREWPANEL_IMAGES_ID_TIMER_PANEL_BOIL_INPUT             = 129,
    BREWPANEL_IMAGES_ID_COUNT                              = 130 
};
